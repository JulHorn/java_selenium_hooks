...
public class Test {
    ...
    public void setUp() {
        ...
        // Registers the hooks for the webdriver
        HookHandler.registerHooks(webDriver, "./hooks/Hooks.xml");
    ...
    public void bingExampleTest() {
        ...
        PageFactory.initElements(webDriver, bingPage);
